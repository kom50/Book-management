<template>
    <div class="flex min-h-full flex-1 flex-col justify-center px-2 py-12 lg:px-8">
        ...
        <div
            class="mt-10 sm:mx-auto sm:w-full sm:max-w-md shadow-sm border-[0.6px] border-gray-50 sm:px-10 p-6 sm:py-12 bg-white rounded-lg">
            <form class="space-y-6" action="#">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="email" type="email" autocomplete="current-password" required="true"
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                ...
                {{ ' ' }}
                <router-link to="/register" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> CREATE
                    ACCOUNT</router-link>
            </p>
        </div>
    </div>
